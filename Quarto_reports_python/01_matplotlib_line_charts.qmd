...
This is an example on how to create Bar charts using Matplotlib in Python. After installing required Quarto extension in VS code we load required libraries.
...
### 1.1 Type I Attendances bar line
